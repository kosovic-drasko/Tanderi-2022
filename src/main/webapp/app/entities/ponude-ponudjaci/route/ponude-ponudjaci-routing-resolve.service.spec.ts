...
describe('PonudePonudjaci routing resolve service', () => {
  ...
  let resultPonudePonudjaci: IPonudePonudjaci | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return new IPonudePonudjaci if id is not provided', () => {
      // GIVEN
      ...
      expect(resultPonudePonudjaci).toEqual(new PonudePonudjaci());
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse({ body: null as unknown as PonudePonudjaci })));
      mockActivatedRouteSnapshot.params = { id: 123 };
