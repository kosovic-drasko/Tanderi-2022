...
public class PonudjaciResource {
    ...
    public ResponseEntity<Ponudjaci> partialUpdatePonudjaci(
        ...
        Optional<Ponudjaci> result = ponudjaciRepository
            ...
            .map(existingPonudjaci -> {
                ...
                if (ponudjaci.getOdgovorno_lice() != null) {
                    existingPonudjaci.setOdgovorno_lice(ponudjaci.getOdgovorno_lice());
                }
                if (ponudjaci.getAdresa_ponudjaca() != null) {
                    existingPonudjaci.setAdresa_ponudjaca(ponudjaci.getAdresa_ponudjaca());
                }
                if (ponudjaci.getBanka_racun() != null) {
                    existingPonudjaci.setBanka_racun(ponudjaci.getBanka_racun());
                }
    ...
    public ResponseEntity<List<Ponudjaci>> getAllPonudjacis(@org.springdoc.api.annotations.ParameterObject Pageable pageable) {
