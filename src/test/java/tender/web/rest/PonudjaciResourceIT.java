...
class PonudjaciResourceIT {
    ...
    void createPonudjaci() throws Exception {
        ...
        assertThat(testPonudjaci.getOdgovorno_lice()).isEqualTo(DEFAULT_ODGOVORNO_LICE);
        assertThat(testPonudjaci.getAdresa_ponudjaca()).isEqualTo(DEFAULT_ADRESA_PONUDJACA);
        assertThat(testPonudjaci.getBanka_racun()).isEqualTo(DEFAULT_BANKA_RACUN);
    }
    ...
    void putNewPonudjaci() throws Exception {
        ...
        assertThat(testPonudjaci.getOdgovorno_lice()).isEqualTo(UPDATED_ODGOVORNO_LICE);
        assertThat(testPonudjaci.getAdresa_ponudjaca()).isEqualTo(UPDATED_ADRESA_PONUDJACA);
        assertThat(testPonudjaci.getBanka_racun()).isEqualTo(UPDATED_BANKA_RACUN);
    }
